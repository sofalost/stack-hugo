...
8. **Skills** — déploie les 27 skills dans 5 dossiers (claude, hermes, opencode, codex, agents) + les 4 skills 9router téléchargés depuis GitHub + install dans OpenClaw. Les skills sont ainsi visibles aussi dans **dsh** (le profil web désactive le plugin par défaut ; le script le réactive via `~/.dsh/profiles/web/cordis.patch.yml`).
