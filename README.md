...
2. **Conteneur 9router ?** — demande si un conteneur Docker nommé `9router` existe déjà. Réponse gardée dans `HAS_9ROUTER`, utilisée à l'étape Skills. Si non : les skills 9router et les scripts 9mode sont ignorés (rien d'autre n'est skippé).
